...
public class CartAdapterEntity extends RecyclerView.Adapter<CartAdapterEntity.CartViewHolder>{
    Context context;
    List<CartEntity> cartList;

    public CartAdapterEntity(Context context, List<CartEntity> cartList) {
    ...
    @NonNull
    @Override
    public CartAdapterEntity.CartViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_cart,parent,false);
        return new CartViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CartAdapterEntity.CartViewHolder holder, int position) {
...
//        holder.tvToTalPrice.setText(String.valueOf("$ "+total));
    ...
    public void resetCart(@NonNull CartAdapterEntity.CartViewHolder holder,CartEntity cart){
...
//        holder.tvToTalPrice.setText(String.valueOf("$ "+total));
    ...
    public void deleteProductCart(@NonNull CartAdapterEntity.CartViewHolder holder,CartEntity cart){
